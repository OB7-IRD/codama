...
test_that("Doctest: logbook_buoy_time_control", {
  ...
  activity_time = c("15:26:01", "15:36:01", "17:49:00", "18:30:00", "18:31:00", "09:26:01", "09:42:01", "21:35:01",
    "21:35:01"), time_interval_before = structure(c(NA, NA, 132.983333333333, NA, NA, NA, 16, NA, 0), class = "difftime",
  units = "mins"), time_interval_after = structure(c(NA, 132.983333333333, NA, NA, NA, 16, NA, 0, NA), class = "difftime",
  units = "mins"), logical = c(TRUE, TRUE, TRUE, TRUE, TRUE, FALSE, FALSE, FALSE, FALSE)), row.names = c(NA, -9L), class = c(
