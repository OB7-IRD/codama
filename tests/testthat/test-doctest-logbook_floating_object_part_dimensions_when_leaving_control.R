...
test_that("Doctest: logbook_floating_object_part_dimensions_when_leaving_control", {
  ...
  dataframe2 <- data.frame(floatingobjectpart_id = c("1", "2", "3", "4"), objectmaterial_code = c("1-1-1-1-6",
    "1-1-2-11", "1-1-1-1-7", "1-1"), floatingobjectpart_whenleaving = c("3", "5", "1", "true"), floatingobject_id = c(
    "1", "1", "3", "3"))
