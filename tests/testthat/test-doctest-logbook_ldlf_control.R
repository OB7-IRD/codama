...
test_that("Doctest: logbook_ldlf_control", {
  ...
  # Source line: 28
  dataframe1 <- data.frame(samplespecies_id = c("1", "2", "3", "4", "5", "6"), species_fao_code = c("SKJ", "SKJ", "JOS",
    "SKJ", "SKJ", "JOS"), sizemeasuretype_code = c("FL", "PD1", "PD1", "FL", "FL", "PD1"), sample_id = c("1", "1", "1",
    "2", "3", "4"))
  dataframe2 <- data.frame(sample_id = c("1", "2", "3", "4"), sample_smallsweight = c(5, 0, 0, 7), sample_bigsweight = c(
    12, NA, 6, 0), sample_totalweight = c(0, 23, NA, NA))
