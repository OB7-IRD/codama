#' @name logbook_sample_harbour_control
#' @title Gives inconsistencies between the presence of a sample and the absence of a harbour of landing
#' @description The purpose of the logbook_sample_harbour_control function is to provide a table of data that contains an inconsistency between the presence of a sample and the absence of a harbour of landing
#' @param dataframe1 {\link[base]{data.frame}} expected. Csv or output of the function {\link[furdeb]{data_extraction}}, which must be done before using the logbook_sample_harbour_control function.
#' @param dataframe2 {\link[base]{data.frame}} expected. Csv or output of the function {\link[furdeb]{data_extraction}}, which must be done before using the logbook_sample_harbour_control function.
...
#' @export
logbook_sample_harbour_control <- function(dataframe1,
                                           dataframe2,
                                           output) {
