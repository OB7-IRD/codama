#' @name logbook_super_sample_number_control
#' @title Gives the inconsistencies between the sample and the subsample number
#' @description The purpose of the logbook_super_sample_number_control function is to provide a table of data that contains an inconsistency between the sample and the subsample number
#' @param dataframe1 {\link[base]{data.frame}} expected. Csv or output of the function {\link[furdeb]{data_extraction}}, which must be done before using the logbook_super_sample_number_control() function.
#' @param dataframe2 {\link[base]{data.frame}} expected. Csv or output of the function {\link[furdeb]{data_extraction}}, which must be done before using the logbook_super_sample_number_control() function.
