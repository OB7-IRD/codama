#' @name logbook_sample_without_measure_control
#' @title Gives inconsistencies between the sample and the measurement in terms of presence
#' @description The purpose of the logbook_sample_without_measure_control function is to provide a table of data that contains an inconsistency between the sample and the presence of measurement
#' @param dataframe1 {\link[base]{data.frame}} expected. Csv or output of the function {\link[furdeb]{data_extraction}}, which must be done before using the logbook_sample_without_measure_control() function.
#' @param dataframe2 {\link[base]{data.frame}} expected. Csv or output of the function {\link[furdeb]{data_extraction}}, which must be done before using the logbook_sample_without_measure_control() function.
...
#' @export
logbook_sample_without_measure_control <- function(dataframe1,
                                                   dataframe2,
                                                   output) {
