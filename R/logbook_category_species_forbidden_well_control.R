#' @name logbook_category_species_forbidden_well_control
#' @title Gives the inconsistencies between the weight categories and the species in the well
#' @description The purpose of the logbook_category_species_forbidden_well_control function is to provide a table of data that contains an inconsistency between the weight categories and the species in the well
#' @param dataframe1 {\link[base]{data.frame}} expected. Csv or output of the function {\link[furdeb]{data_extraction}}, which must be done before using the logbook_category_species_forbidden_well_control () function.
...
#' @export
logbook_category_species_forbidden_well_control <- function(dataframe1,
                                                            output,
                                                            species = c("SKJ"),
