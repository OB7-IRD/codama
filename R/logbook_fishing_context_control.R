#' @name logbook_fishing_context_control
#' @title Gives the inconsistencies between the school type and the association
#' @description The purpose of the logbook_fishing_context_control function is to provide a table of data that contains an inconsistency with school type and the association
#' @param dataframe1 {\link[base]{data.frame}} expected. Csv or output of the function {\link[furdeb]{data_extraction}}, which must be done before using the logbook_fishing_context_control () function.
#' @param dataframe2 {\link[base]{data.frame}} expected. Csv or output of the function {\link[furdeb]{data_extraction}}, which must be done before using the logbook_fishing_context_control () function.
...
#' @export
logbook_fishing_context_control <- function(dataframe1,
                                            dataframe2,
                                            output,
