...
check_raising_factor_inspector <- function(dataframe1,
  ...
  if (!codama::r_table_checking(
    ...
    dataframe1 <- dataframe1[, c("floatingobject_id")]
  }
  if (!codama::r_table_checking(
    r_table = dataframe2,
    type = "data.frame",
    column_name = c("transmittingbuoy_id", "transmittingbuoyoperation_code"),
    ...
    dataframe2 <- dataframe2[, c("transmittingbuoy_id", "transmittingbuoyoperation_code")]
  }
