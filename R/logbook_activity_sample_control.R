#' @name logbook_activity_sample_control
#' @title Gives inconsistencies between the sample and the activity in terms of presence
#' @description The purpose of the logbook_activity_sample_control function is to provide a table of data that contains an inconsistency between the sample and the existence of the activity
#' @param dataframe1 {\link[base]{data.frame}} expected. Csv or output of the function {\link[furdeb]{data_extraction}}, which must be done before using the logbook_activity_sample_control () function.
#' @param dataframe2 {\link[base]{data.frame}} expected. Csv or output of the function {\link[furdeb]{data_extraction}}, which must be done before using the logbook_activity_sample_control () function.
...
#' @export
logbook_activity_sample_control <- function(dataframe1,
                                            dataframe2,
                                            output) {
