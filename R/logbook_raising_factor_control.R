#' @name logbook_raising_factor_control
#' @title Gives the inconsistencies between RF1 and threshold values
#' @description The purpose of the logbook_raising_factor_control function is to provide a table of data that contains an inconsistency with the RF1 and the valid threshold (Default : 0.9 ; 1.1)
#' @param dataframe1 {\link[base]{data.frame}} expected. Csv or output of the function {\link[furdeb]{data_extraction}}, which must be done before using the logbook_raising_factor_control () function.
#' @param dataframe2 {\link[base]{data.frame}} expected. Csv or output of the function {\link[furdeb]{data_extraction}}, which must be done before using the logbook_raising_factor_control () function.
...
#' @export
logbook_raising_factor_control <- function(dataframe1,
                                           dataframe2,
                                           dataframe3,
                                           dataframe4,
                                           output,
