#' @name logbook_ldlf_control
#' @title Gives the inconsistencies between the sample measurement types and species or weight values
#' @description The purpose of the logbook_ldlf_control  function is to provide a table of data that contains an inconsistency between the sample measurement types and species or weight values
#' @param dataframe1 {\link[base]{data.frame}} expected. Csv or output of the function {\link[furdeb]{data_extraction}}, which must be done before using the logbook_ldlf_control () function.
#' @param dataframe2 {\link[base]{data.frame}} expected. Csv or output of the function {\link[furdeb]{data_extraction}}, which must be done before using the logbook_ldlf_control () function.
...
#' @export
logbook_ldlf_control <- function(dataframe1,
                                 dataframe2,
                                 output,
