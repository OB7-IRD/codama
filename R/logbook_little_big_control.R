#' @name logbook_little_big_control
#' @title Gives the inconsistencies between the percentage of little and big fish sampled
#' @description The purpose of the logbook_little_big_control function is to provide a table of data that contains an inconsistency between the percentage of little and big fish sampled
#' @param dataframe1 {\link[base]{data.frame}} expected. Csv or output of the function {\link[furdeb]{data_extraction}}, which must be done before using the logbook_little_big_control() function.
#' @param dataframe2 {\link[base]{data.frame}} expected. Csv or output of the function {\link[furdeb]{data_extraction}}, which must be done before using the logbook_little_big_control() function.
#' @param dataframe3 {\link[base]{data.frame}} expected. Csv or output of the function {\link[furdeb]{data_extraction}}, which must be done before using the logbook_little_big_control() function.
...
#' @export
logbook_little_big_control <- function(dataframe1,
                                       dataframe2,
                                       dataframe3,
                                       output,
